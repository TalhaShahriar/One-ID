 ...
 */
export async function generateTaxReceiptPDF(taxReturn) {
  ...
  // Right Column
  page.drawText(`Receipt No:`, { x: 340, y: metaY, size: 10, font: fontBold });
  page.drawText(`${taxReturn.receiptNumber || 'N/A'}`, { x: 420, y: metaY, size: 10, font: fontSans });

  page.drawText(`Tax Year:`, { x: 340, y: metaY - 20, size: 10, font: fontBold });
